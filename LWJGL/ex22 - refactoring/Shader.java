...
class Shader{
	...
	public Shader(){
		...
		if(program == 0){
			System.err.println("Shader class, error: 001"); System.exit(1); }
	}
	...
	public void addUniform(String uniform_name){
		...
		if(uniform_pointer == -1){
			System.err.println("Shader class, error: 002"); System.exit(1); }
	...
	public void compileShader(){
		...
		if(GL20.glGetProgrami(program, GL20.GL_LINK_STATUS) == 0){
			System.err.println("Shader class, error: 003");
		...
		if(GL20.glGetProgrami(program, GL20.GL_VALIDATE_STATUS) == 0){
			System.err.println("Shader class, error: 004");
			System.err.println(GL20.glGetProgramInfoLog(program, 1024));
			System.exit(1); }
	}
	...
	private void addProgram(String shader_source, int type){
		...
		if(shader == 0){
			System.err.println("Shader class, error: 005"); System.exit(1); }
		
		GL20.glShaderSource(shader, shader_source);
		GL20.glCompileShader(shader);
		
		if(GL20.glGetShaderi(shader, GL20.GL_COMPILE_STATUS) == 0){
			System.err.println("Shader class, error: 006");
